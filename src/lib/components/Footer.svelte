<footer class="bg-[#050505] text-white pt-24 pb-12 border-t border-white/10">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col items-center text-center mb-24">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Transform your<br>dealer operations</h2>
            <p class="text-gray-400 mb-8 max-w-xl">Stop wasting time on manual quotes. Join leading dealers who've accelerated their sales cycles with DealerOS.</p>
            <button class="bg-[var(--color-canopy-lime)] hover:bg-[var(--color-canopy-lime-hover)] text-white px-8 py-3 rounded-full font-medium transition-colors flex items-center gap-2">
                Get started
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16 border-t border-white/10 pt-16">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Smart Quoting</a></li>
                    <li><a href="#" class="hover:text-white">Workflow Automation</a></li>
                    <li><a href="#" class="hover:text-white">Price Intelligence</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Industrial Suppliers</a></li>
                    <li><a href="#" class="hover:text-white">Distributors</a></li>
                    <li><a href="#" class="hover:text-white">Equipment Dealers</a></li>
                    <li><a href="#" class="hover:text-white">Parts & Service</a></li>
                    <li><a href="#" class="hover:text-white">Sales Teams</a></li>
                </ul>
            </div>
